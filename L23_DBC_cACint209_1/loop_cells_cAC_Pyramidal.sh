...
printf "\n" > cAC_Pyramidal_branch_f300_new.txt
...
do
  ...
  printf "\n$f\n" >> cAC_Pyramidal_branch_f300_new.txt
  python run_netanel_cAC_BranchingPoint_type.py >> cAC_Pyramidal_branch_f300_new.txt
done <"$file"

printf "\n"

# chmod u+x loop_cells_cAC_Pyramidal.sh
# ./loop_cells_cAC_Pyramidal.sh