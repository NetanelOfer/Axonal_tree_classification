...
printf "\n" > bNAC_Interneuron192_branch_f300_new.txt
...
do
  ...
  printf "\n$f\n" >> bNAC_Interneuron192_branch_f300_new.txt
  python run-bNAC_BranchingPoint_type.py >> bNAC_Interneuron192_branch_f300_new.txt
done <"$file"

printf "\n"

# chmod u+x loop_cells_bNAC_Interneuron192.sh
# ./loop_cells_bNAC_Interneuron192.sh