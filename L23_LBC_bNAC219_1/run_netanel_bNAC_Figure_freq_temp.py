...
def create_stimuli(cell, step_number):
    ...
    fff = [120] #range(20,620,20) #[200, 330 , 400]
...
def run_step(step_number, plot_traces=None):
    ...
    ax2.set_xlim([0,neuron.h.tstop]) # 50
    ...
    ax1.text(-50,271,'a', fontsize=15, fontproperties=font)
    #
    #ax1.text(850,271,'D', fontsize=15)
    fig.tight_layout()
    fig.subplots_adjust(wspace=0.06, bottom=0.09)
    fig.savefig('/home/userlab/BBP/NeuroMorpho/recons/Figure_bNAC_freq120c.pdf')
