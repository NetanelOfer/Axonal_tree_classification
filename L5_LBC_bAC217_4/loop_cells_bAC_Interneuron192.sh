...
printf "\n" > bAC_Interneuron192_branch_f300_new.txt
...
do
  ...
  printf "\n$f\n" >> bAC_Interneuron192_branch_f300_new.txt
  python run_bAC_BranchingPoint_type.py >> bAC_Interneuron192_branch_f300_new.txt
done <"$file"

printf "\n"

# chmod u+x loop_cells_bAC_Interneuron192.sh
# ./loop_cells_bAC_Interneuron192.sh