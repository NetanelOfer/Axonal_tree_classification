...
printf "\n" > cNAC_Pyramidal_branch_f300_new.txt
...
do
  ...
  printf "\n$f\n" >> cNAC_Pyramidal_branch_f300_new.txt
  python run_netanel_cNAC_BranchingPoint_type.py >> cNAC_Pyramidal_branch_f300_new.txt
done <"$file"

printf "\n"

# chmod u+x loop_cells_cNAC_Pyramidal.sh
# ./loop_cells_cNAC_Pyramidal.sh