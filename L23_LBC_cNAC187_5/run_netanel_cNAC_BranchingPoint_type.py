...
def create_stimuli(cell, step_number):
    ...
    fff = [300] # range(20,620,20) #[200, 330 , 400]
...
def run_step(step_number, plot_traces=None):
    ...
    BP = [BP_same , BP_diff , (num_axon_sec-1)/2]
    print BP , ","
    #print 'BP_same=' , BP_same
    #print 'BP_diff=' , BP_diff
    #if (En==[]):
    #  En=[len(new_pos)]
    #print En
    #print "sum En:" , sum(En), "len En:" , len(En)
    #[14, 2, 4, 10, 6, 50, 68, 12, 2, 12, 4, 4, 4, 48, 10]
